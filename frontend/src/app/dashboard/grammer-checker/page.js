...
function GrammerChecker() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <h2 className="text-3xl text-center">Grammar Checker</h2>
      ...
      <div>
        ...
        ></textarea>
        <button
          className="mt-3 bg-green-600 hover:bg-green-700 transition text-white px-10 py-2 rounded shadow"
